            ...
            if ("1".equals(detail.userType)) {
                ...
                if (detail.showHtml != null && detail.showHtml) {//机器人头像
                    ...
                    if (!"".equals(xiaomoRobotAvator1)) {
                        ...
                        Glide.with(context).load(xiaomoRobotAvator1 + "?imageView2/0/w/200/h/200/q/90").apply(new RequestOptions().error(R.drawable.kf_head_default_robot)).into(baseHolder.getChattingAvatar());
                    ...
                    Glide.with(context).load(imgPath + "?imageView2/0/w/100/h/100").apply(new RequestOptions().error(R.drawable.kf_head_default_robot)).into(baseHolder.getChattingAvatar());
