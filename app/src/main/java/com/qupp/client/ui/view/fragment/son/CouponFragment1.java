...
import com.qupp.client.utils.adapter.CouponAdapter1;
...
public class CouponFragment1 extends Fragment {
    ...
    public static CouponFragment1 newInstance(int page) {
        Bundle args = new Bundle();
        CouponFragment1 checkOrderFragment = new CouponFragment1();
    ...
    private void initAdapter(List<EntityForSimple> data) {
        ...
        mAdapter = new CouponAdapter1(data,page);
    ...
    private void getData() {
        ApiUtil.getApiService().getMyPage(MyApplication.getToken(),(type+1)+"", size + "", current + "").enqueue(new Callback<MessageForSimple>() {
            @Override
