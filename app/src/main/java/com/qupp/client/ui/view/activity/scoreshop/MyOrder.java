...
import com.qupp.client.ui.view.fragment.son.MyOrderFragment;
...
@SuppressLint("all")
public class MyOrder extends BaseActivity implements CommonTabPagerAdapter.TabPagerListener {
    ...
    private void initMagicIndicator(List<String> titles) {
        ...
        commonNavigator.setAdapter(new CommonNavigatorAdapter() {
            ...
            public IPagerIndicator getIndicator(Context context) {
                ...
                linePagerIndicator.setLineHeight(ScreenAdaptive.dp2px(MyOrder.this, 2));
    ...
    public static void startActivityInstance(Activity activity) {
        activity.startActivity(new Intent(activity, MyOrder.class));
    }
