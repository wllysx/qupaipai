...
public class BalanceDetailActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linear.setPadding(0, MyApplication.getStateBar(BalanceDetailActivity.this), 0, 0);
    ...
    private void initAdapter(List<EntityForSimple> data) {
        ...
        mAdapter.setOnItemChildClickListener((adapter, view, position) -> BalanceDetailMoreActivity.startActivityInstance(BalanceDetailActivity.this,tvBalance.getText().toString()));
    ...
    public static void startActivityInstance(Activity activity,String amount) {
        activity.startActivity(new Intent(activity, BalanceDetailActivity.class)
    ...
    private void getMyAmount() {
        ApiUtil.getApiService().myAmount(MyApplication.getToken(), id, size + "", null).enqueue(new Callback<MessageForList>() {
            @Override
                    ...
                    if (entity.getCode().equals("0")) {
                        if (id.equals("0")) {
                           ...
                           /* if (entity.getData().size() == 0) {
                            ...
                            if(entity.getData().size()<size){
                                //已加载全部
                                springview.setEnableFooter(false);

                                EntityForSimple entityForSimple = new EntityForSimple();
                                entityForSimple.setChecked(true);
                                datas.add(entityForSimple);
