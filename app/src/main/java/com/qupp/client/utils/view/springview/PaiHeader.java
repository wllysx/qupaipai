 ...
 */
public class PaiHeader extends BaseHeader {
    ...
    public PaiHeader(Context context){
        this(context, R.drawable.progress_small,R.drawable.arrow);
    }

    public PaiHeader(Context context, int rotationSrc, int arrowSrc){
    ...
    public View getView(LayoutInflater inflater, ViewGroup viewGroup) {
        View view = inflater.inflate(R.layout.springview_default_header_pai, viewGroup, true);
        tv_shuaxin = view.findViewById(R.id.tv_shuaxin);
