...
public class MiddleDialogReverse {

    private Context context;
    private Dialog dialog;
    MiddleDialogReverse middleDialog;

    public MiddleDialogReverse(Context context) {
        super();
    ...
    public void show(String titleName, String content,String cancelText,String sureText,boolean isOnlySure) {
        View view = LayoutInflater.from(context).inflate(R.layout.dialog_middle_reverse, null);
     ...
     * @param sure
     */
    public MiddleDialogReverse setSureListener(Sure sure) {
        this.sure = sure;
        return middleDialog;
    }
