...
public class MainItemAdapter2 extends BaseAdapter {
    ...
    public MainItemAdapter2(Context context, List<EntityForSimple> mDatas) {
        mContext = context;
        this.mDatas = mDatas;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        try {
           ...
           /* if(mDatas.get(position).getIsLimitPrice().equals("1")||mDatas.get(position).getIsGiveIntegral().equals("0")) {
                if(mDatas.get(position).getIsLimitPrice().equals("1")){
                    //限价
                    holder.ivBiaoqian.setImageResource(R.mipmap.icon_xianjia);
                    holder.ivBiaoqian.setVisibility(View.VISIBLE);
                }
                if(mDatas.get(position).getIsGiveIntegral().equals("0")){
                    //超值
                    holder.ivBiaoqian.setImageResource(R.mipmap.icon_chaozhi);
                    holder.ivBiaoqian.setVisibility(View.VISIBLE);
                }
            }else{
                holder.ivBiaoqian.setVisibility(View.GONE);
            }*/
