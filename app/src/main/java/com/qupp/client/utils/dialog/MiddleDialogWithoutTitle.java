...
public class MiddleDialogWithoutTitle {
    ...
    MiddleDialogWithoutTitle middleDialog;
     ...
     * @param sureText 确定文字
     */
    public void show(String content,String cancelText,String sureText,boolean isOnlySure) {
        View view = LayoutInflater.from(context).inflate(R.layout.dialog_middle_withouttitle, null);
