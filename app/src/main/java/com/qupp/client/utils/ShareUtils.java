...
/**
 * author: MrWang on 2019/8/20
 * email:773630555@qq.com
 * date: on 2019/8/20 10:30
 */
...
public class ShareUtils {
    ...
    public static void shareUmMin(final Activity activity, String WebUrl, String title, String description, String imageUrl,String minPath) {
        ...
        //小程序页面路径
        umMin.setUserName("gh_f11cf54b44fa");
        // 小程序原始id,在微信平台查询
        new ShareAction(activity)
                .withMedia(umMin)
    ...
    public static void shareUmMin1(final Activity activity, String WebUrl, String title, String description, int imageUrl,String minPath) {
